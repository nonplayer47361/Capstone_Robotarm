@echo off
title Berry YOLO Labeling Tool
setlocal
cd /d "%~dp0"

echo ================================================
echo   Berry YOLO Labeling Tool  v2.1
echo   Blueberry / Strawberry clay model labeling
echo ================================================
echo.
...
:: ── Launch tool ──────────────────────────────────
echo [3/3] Starting labeling tool...
echo.
%PYTHON_CMD% start_labeling.py %*
if errorlevel 1 (
    echo.
    echo [ERROR] Labeling tool exited with an error.
)
pause
